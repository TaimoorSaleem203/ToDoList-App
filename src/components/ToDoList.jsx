...
const ToDoList = ({task,setTask,inputValue,setInputValue}) => {
    ...
    return (
        <div className="relative w-full max-h-full">
            <img src={mainList} className="w-full shadow-sm rounded-lg shadow-black/20" alt="bar" />
            <ul className="absolute inset-0 p-5 pt-5 text-lg flex flex-col overflow-y-auto gap-2 font-semibold">
                {/* <input type="text" className="absolute mt-5 rounded-lg w-full overflow-x-hidden top-0 shadow"/> */}
                        ...
                        return (
                            <li className="bg-white/70 rounded-lg p-2 flex items-center justify-between shadow-md">
                                ...
                                <div className="flex items-center font-semibold gap-3">
                                    <i class="ri-check-line cursor-pointer transition-color duration-150 active:scale-95 hover:text-green-700"></i>
